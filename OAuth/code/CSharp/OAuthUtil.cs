...
namespace iServe.Models.F1APIServices {
	public class OAuthUtil {
		...
		public OAuthUtil(string baseAPIUrl, string churchCode, string apiVersion, string f1LoginMethod, string consumerKey, string consumerSecret) {
			...
			//<add key="RequestUrl" value="https://[churchCode].staging.fellowshiponeapi.com/v1/Tokens/RequestToken"/>
			//<add key="UserAuthorizeUrl" value="https://[churchCode].staging.fellowshiponeapi.com/v1/WeblinkUser/Login"/>
			//<add key="AccessUrl" value="https://[churchCode].staging.fellowshiponeapi.com/v1/Tokens/AccessToken"/>
			...
			_accessUrl = CreateAPIUrl(churchCode, baseAPIUrl, apiVersion, "Tokens/AccessToken");
